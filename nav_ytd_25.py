...
# exclude na values
# df = df[df['Individual\'s Date of Birth:'].notna()]

df['Individual\'s Date of Birth:'] = df['Individual\'s Date of Birth:'].fillna("N/A")
...
locations_unique = [
'GudLife', "Black Men's Health Clinic", 'BMHC', 'Southbridge', 'SouthBridge', 'Extended Stay America', 'The Bumgalows', 'The Bungalows', 'PHONE CONTACT', 'PHONE', 'last known area was St. John. Connected with Hungry Hill to help me search for client', 'Extended Stay America (Host Hotel)', 'Downtown Austin Community Court', 'Outreach', 'Office (remote)', 'over phone', 'South Bridge', 'phone', 'Cross Creek Hospital', 'Outreach in the field', 'phone call', 'Cross creek hospital', 'over the phone', 'Integral Care St. John Office', 'Extended Stay America Hotel', 'Hungry Hill/Austin Urban League', 'Home of resident', 'Community First Village', 'Cross Creek hospital', 'Vivent Health', 'Clients home', 'picked client up from encampment for SSA appointment', 'Terrezas public Library', 'Terreaz Public Library', 'Social Security Administration office', 'Round Rock library', 'EXTENDED STAY AMERICA', 'Phone call', 'Social Security office', 'Pflugerville library /on the phone after leaving client', 'out in field', 'integral Care- St. John Location', 'Housing Authority of Travis County', 'ICare and social security office', 'Phone appt', 'Hybrid Meeting', 'Social Security Office', 'Pflugerville library/Phone call', 'phone call/Integral care St John location', 'Bungalows', 'Sunrise Navigation Homeless Center', 'capital villas apartments', 'Deep in the trenches', 'met client at southbridge to complete check in and discussed what options we had for us to be able to obtain missing vital docs', 'picking client up from encampment, vital statics appointment and walk in at social security office, then returning client back to encampment area', 'Austin Transitional Center', 'Austin transitional Center', 'Austin Transistional Center', 'Austin Transitional center', 'ATC', 'Transitions of Care', 'via zoom', 'Phone call and visit to 290/35 area where unhoused', 'Cenikor Austin', 'social security office and DPS (NORTH LAMAR)', 'DPS Meeting (pflugerville locations)', 'Terrazas Branch Library', 'Trinity Center', 'Nice project riverside and Montopolis', 'Integral Care - St. John', 'Terrazas Library', 'ESPERO', 'Event', 'St. John’s Health Fair', 'Terrazas library', 'Community Outreach', 'Austin Library'
]
        ...
        html.Div(
            ...
            html.Div(
                ...
                children=[
                    html.A(
                        'Repo',
                        href=f'https://github.com/CxLos/Nav_YTD_{report_year}',
                        className='btn'),
                ]),
    ]),  
